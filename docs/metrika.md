...
Для штатной проверки Яндекса запрос с `_ym_status-check=112046844` точечно разрешает inline-стили диагностической панели и связь с открывшим её кабинетом. Обычные страницы сохраняют строгий CSP, `Cross-Origin-Opener-Policy` и `X-Frame-Options`. Аналогичное исключение для стилей действует у официальной панели `_ym_debug=2`.
